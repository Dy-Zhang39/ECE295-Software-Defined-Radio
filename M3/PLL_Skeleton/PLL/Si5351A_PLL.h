 ...
 * Si5351A_PLL.h
 *
 * Created: 2021-10-02 3:11:57 PM
 *  Author: StewartPearson
 * Source: https://learn.adafruit.com/adafruit-si5351-clock-generator-breakout
 */ 
...
#define SI5351_FREQ_MULT                1ULL
#define SI5351_DEFAULT_CLK              1000000000ULL
#define SI5351_PLL_VCO_MIN              375000000 //15*25 MHz
#define SI5351_PLL_VCO_MAX              900000000
#define SI5351_NO_RDIV_MIN_FREQ         2952756 // Rdiv messes up the delay
#define SI5351_MULTISYNTH_MIN_FREQ      500000
//#define SI5351_MULTISYNTH_MIN_FREQ      8000
...
#define SI5351_CLKOUT_MIN_FREQ          23100//8000 had to raise from 8kHz because of phase offset requirements
...
uint8_t select_r_div(uint32_t *freq);


#endif /* SI5351A_PLL_H_ */